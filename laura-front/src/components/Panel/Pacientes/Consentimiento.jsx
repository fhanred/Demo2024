...
<div style={{textAlign:"justify", margin:"0 auto", width:"700px"}}>
  {consentimiento?.type == 1 && <p className={style.consen}><h3>INDICACIONES DE CUIDADOS PRE y POST-OPERATORIOS PARA PACIENTES ORTODONTICOS CON MINI IMPLANTES</h3>
                ...
                *Concurrir al consultorio con acompañante.
                ...
                + CONTROLES: Concurrir a las consultas de control, establecidas.</p>}

            {consentimiento?.type == 2 && <p className={style.consen}><h3>CONSENTIMIENTO INFORMADO DE ENDODONCIA</h3>

                Ciudad: <input value={paciente.ciudad} disabled type="text" className={style.inputCon} /><br></br>
                Fecha : <input type="date" value={consentimiento?.date} disabled name="date"  className={style.inputCon} /> <br></br><br></br>
                Yo: <input value={paciente.name} disabled type="text" className={style.inputCon} /> identificado con CC <input value={paciente.cedula} disabled type="text" className={style.inputCon} />
                actuando en nombre propio o como representante legal del menor de edad o persona con incapacidad mental para tomar
                decisiones cuyo nombre es: <input type="text" value={consentimiento?.menorname} disabled name="menorname"  className={style.inputCon} /> con documento de identidad No. <input type="text"  name="menorcedula" value={consentimiento?.menorcedula} disabled className={style.inputCon} />
            ...
            {consentimiento?.type == 3 && <p className={style.consen}><h3>CONSENTIMIENTO INFORMADO PARA PACIENTES ORTODONTICOS CON MINI-IMPLANTES</h3>
                ...
                NOMBRE Y APELLIDO DEL PROFESIONAL:<input type="text" name="profesional"  value={consentimiento?.profesional} disabled className={style.inputCon} />
                <br></br>
                CONSULTORIO:<input type="text" name="consultorio" value={consentimiento?.consultorio} disabled className={style.inputCon} />
                ...
                <br></br>
                Fecha: <input type="date" value={consentimiento?.date} disabled className={style.inputCon} />
            </p>}
            {consentimiento?.type == 4 && <p className={style.consen}><h3>CONSENTIMIENTO INFORMADO DE OPERATORIA DENTAL</h3>
                ...
                <br></br>
                Fecha: <input type="date" name="date" value={consentimiento?.date} disabled className={style.inputCon} /> 
                <br></br><br></br>
                ...
                decisiones cuyo nombre es: <input type="text" name="menorname" value={consentimiento?.menorname} disabled className={style.inputCon} /> con documento de identidad No. <input type="text" name="menorcedula" value={consentimiento?.menorcedula} disabled className={style.inputCon} />
                <br></br>
                <br></br>
                <h4>DECLARO QUE SE ME HA INFORMADO</h4>
                <br></br>
            ...
            {consentimiento?.type == 5 && <p className={style.consen}>
                ...
                {paciente.edad > 17 ? <p>El Sr(a)<input type="text" disabled value={paciente.name} className={style.inputCon} />  de <input type="text" value={paciente.edad} disabled className={style.inputCon} />años de edad,
                    ...
                    <p>El Sr(a) <input type="text" value={paciente.name} disabled className={style.inputCon} /> de <input type="text" disabled value={paciente.edad} className={style.inputCon} /> años de edad,  con cedula
                        ...
                        acudiente de el Sr(a) <input type="text" name="menorname" value={consentimiento?.menorname} disabled className={style.inputCon} />.</p>}
                        <br></br>
                        <h4>DECLARO</h4>
                <br></br>
                Que el/la Dr.(a) <input type="text" name="profesional"  value={consentimiento?.profesional} disabled className={style.inputCon} /> me ha
            ...
            {consentimiento?.type == 6 && <p className={style.consen}><h3>CONSENTIMIENTO INFORMADO PARA URGENCIAS ODONTOLOGICAS</h3>
                ...
                Yo: <input type="text" value={paciente.name} disabled className={style.inputCon} />  identificado con  CC <input type="text" disabled value={paciente.cedula} className={style.inputCon} />
                Actuando en nombre propio  o como represent legal del menor de edad o de la persona con
                incapacidad mental para tomar decisiones cuyo nombre es: <input type="text" value={consentimiento?.menorname} disabled className={style.inputCon} />
                con documento de identidad No <input type="text" value={consentimiento?.menorcedula} disabled className={style.inputCon} />
                <br></br><br></br>
                <h4>DECLARO QUE SE ME HA INFORMADO</h4>
                <br></br>
